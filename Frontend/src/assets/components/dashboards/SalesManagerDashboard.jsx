...
const SalesManagerDashboard = () => {
    ...
    const fetchTasks = async () => {
        try {
            const { data } = await axios.get('https://backendrender-3jek.onrender.com/salemanager/alltasks');
    ...
    const fetchLabours = async () => {
        try {
            const { data } = await axios.get('https://backendrender-3jek.onrender.com/salemanager/alllabour');
    ...
    const fetchLabourTimes = async () => {
        try {
            const { data } = await axios.get('https://backendrender-3jek.onrender.com/salemanager/labourtimes');
    ...
    const addTask = async () => {
        ...
        try {
            const response = editing
                ? await axios.put(`https://backendrender-3jek.onrender.com/salemanager/alltasks/${taskToSave._id}`, taskToSave)
                : await axios.post('https://backendrender-3jek.onrender.com/salemanager/alltasks', taskToSave);
