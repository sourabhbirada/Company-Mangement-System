...
const HRDashboard = () => {
    ...
    useEffect(() => {
        ...
        axios.get("https://backendrender-3jek.onrender.com/hr/allattendence")
            .then((response) => {
            ...
            axios.get("https://backendrender-3jek.onrender.com/hr/getsalary")
.then((response) => {
...
.catch((error) => {
    ...
    const updateSalaryStatus = async (salaryId, newStatus) => {
        ...
        try {
            const response = await axios.put(`https://backendrender-3jek.onrender.com/hr/updatesalary/${salaryId}`, {
                status: newStatus
            });
