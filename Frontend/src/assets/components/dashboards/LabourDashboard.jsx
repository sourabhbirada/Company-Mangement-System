...
const LabourDashboard = () => {
    ...
    const fetchTasks = async () => {
        try {
            const response = await axios.get('https://backendrender-3jek.onrender.com/labour/labourTasks', { withCredentials: true });
    ...
    const handleStatusChange = async (taskId, newStatus) => {
        try {
            await axios.put(
                `https://backendrender-3jek.onrender.com/labour/labourTasks/${taskId}`,
                { status: newStatus },
    ...
    const handleLogout = async () => {
        try {
            await axios.post('https://backendrender-3jek.onrender.com/user/labourlogout', {}, { withCredentials: true });
